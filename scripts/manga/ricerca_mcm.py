...
# -*- coding: utf-8 -*-
"""
ricerca_mcm.py v5.0 — URL diretta + modalita AUTO/MANUAL
=========================================================
...
NOVITA v5.0 (performance):
  ...
  P2 - MAX_PAGES_AUTO = 1 vs MAX_PAGES_MANUAL = 5
       Ricerca automatica: 1 pagina; ricerca manuale: fino a 5
  P3 - TARGET_ITEMS_AUTO = 20 vs TARGET_ITEMS_MANUAL = 96
       Scroll si ferma a 20 item in modalita auto (~50% meno scroll)
...
MAX_PAGES_MANUAL = 5   # ricerca manuale: fino a 5 pagine
MAX_PAGES        = MAX_PAGES_MANUAL  # default (compatibilita)

# P3: target item per modalita
TARGET_ITEMS_AUTO   = 20   # ricerca automatica: primi 20 risultati
...
def _scroll_to_load_all(
    ...
    """
    P3: expected ridotto a TARGET_ITEMS_AUTO (20) in modalita auto.
...
def _fetch_search_pages(
    ...
    mode = "auto"   -> MAX_PAGES_AUTO=1, TARGET_ITEMS_AUTO=20,
                       URL diretta ?q=, no prompt interattivi
    mode = "manual" -> MAX_PAGES_MANUAL=5, TARGET_ITEMS_MANUAL=96,
            ...
            with sync_playwright() as pw:
                ...
                try:
                    ...
                    for pg_num in range(1, max_pages + 1):
                        ...
                        # P3: target ridotto in auto, no prompt in auto
                        _scroll_to_load_all(
                            pg,
                            expected=target,
                        ...
                        # P2: in auto non clicca pagina successiva
...
def handle_ricerca_mcm() -> None:
    ...
    while True:
        ...
        print(f"  Ricerca titoli nel catalogo MCM  (max {MAX_PAGES_MANUAL} pagine x {TARGET_ITEMS_MANUAL} titoli/pagina)")
        ...
        def _reprint():
            ...
            print(f"  MangaComicsMarket.it  ({MAX_PAGES_MANUAL} pag. | {TARGET_ITEMS_MANUAL} tit./pag.)")
