...
# -*- coding: utf-8 -*-
"""
ricerca_mcm.py v5.8 — 1 pagina x 96 risultati (AUTO e MANUAL)
# FIX v5.8: ottimizzazioni timing AUTO (stall 3000->1200ms, skip wait 300ms, skip wait 200ms cookie)
...
def _scroll_to_load_all(
    ...
    while elapsed < timeout_ms:
        ...
        if count == last_count:
            stall_ms += step_ms
            _stall_limit = 1_200 if is_auto else 3_000  # FIX v5.8: limite stall ridotto in AUTO
